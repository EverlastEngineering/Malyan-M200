...
#define X_ENABLE_INIT WRITE(X_ENABLE_PIN,0);SET_OUTPUT(X_ENABLE_PIN)
...
#define Y_ENABLE_INIT WRITE(Y_ENABLE_PIN,0);SET_OUTPUT(Y_ENABLE_PIN)
...
#define Y2_ENABLE_READ READ(Y2_ENABLE_PIN)
  ...
  #define Z_ENABLE_INIT WRITE(Z_ENABLE_PIN,0);SET_OUTPUT(Z_ENABLE_PIN)
